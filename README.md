...
Исходники Telegram сюда не скопированы: CI забирает их с зафиксированного коммита `45ab8f4308496e1f01026a97fcdb0d58a5274474` официального репозитория. Соответствующий исходный код собранного APK — это данный репозиторий плюс тот коммит.
